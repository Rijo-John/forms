            ...
            if (results.data.length > 0) {
                ...
                $.each(formData, function (i, val) {
                    ...
                    if (count == '1') {
                        ...
                        var closeBtn = '<div class="col-md-2"><label>&nbsp;</label><div class="text-center"><button type="button" style="background-color:red" onclick="removeThis(' + count + ')">-</button></div></div>';
                    ...
                    if (val.html_field_id == '3') {
                        ...
                        $.each(val.options, function (i, dat) {
                            ...
                            if (divCount == 1) {
                                ...
                                var divData1 = '<div class="text-center"><button type="button" onclick="removeThisOption(' + count + ',' + divCount + ');">-</button></div>';
                            }
...
function addmores() {
    ...
    if (count == '1') {
        ...
        closeBtn = '<div class="col-md-2"><label>&nbsp;</label><div class="text-center"><button type="button" style="background-color:red" onclick="removeThis(' + count + ')">-</button></div></div>';
